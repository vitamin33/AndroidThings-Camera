...
public class DoorbellCamera {
    ...
    private Runnable mReadyCameraRunnable;
    ...
    public void initializeCamera(Context context,
        ...
        initializeCamera(context, backgroundHandler, imageAvailableListener, null);
    }

    public void initializeCamera(Context context, Handler backgroundHandler, ImageReader.OnImageAvailableListener imageAvailableListener, Runnable readyCameraRunnable) {

        mReadyCameraRunnable = readyCameraRunnable;
        ...
        mImageReader = ImageReader.newInstance(CameraHandler.IMAGE_WIDTH, CameraHandler.IMAGE_HEIGHT,
                ImageFormat.JPEG, 2);
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            if (mReadyCameraRunnable != null) {
                mReadyCameraRunnable.run();
            }
        }
